...
{
    partial class ProjeSablonEditXF
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProjeSablonEditXF));
            ...
            this.f = new DevExpress.XtraRichEdit.UI.RichEditBarController();
            ...
            this.richEditControl1.Size = new System.Drawing.Size(819, 424);
            ...
            this.ribbonControl1.Size = new System.Drawing.Size(819, 142);
            // 
            // fileNewItem1
            // 
            ...
            // ıncreaseIndentItem1
            // 
            this.ıncreaseIndentItem1.Id = 45;
            ...
            // 
            this.ınsertTableOfContentsItem1.Id = 105;
            ...
            // 
            this.ınsertCaptionPlaceholderItem1.Id = 118;
            ...
            // 
            this.ınsertMergeFieldItem1.Id = 127;
            ...
            // f
            // 
            this.f.BarItems.Add(this.fileNewItem1);
            this.f.BarItems.Add(this.fileOpenItem1);
            this.f.BarItems.Add(this.fileSaveItem1);
            this.f.BarItems.Add(this.fileSaveAsItem1);
            this.f.BarItems.Add(this.quickPrintItem1);
            this.f.BarItems.Add(this.printItem1);
            this.f.BarItems.Add(this.printPreviewItem1);
            this.f.BarItems.Add(this.undoItem1);
            this.f.BarItems.Add(this.redoItem1);
            this.f.BarItems.Add(this.pasteItem1);
            this.f.BarItems.Add(this.cutItem1);
            this.f.BarItems.Add(this.copyItem1);
            this.f.BarItems.Add(this.pasteSpecialItem1);
            this.f.BarItems.Add(this.changeFontNameItem1);
            this.f.BarItems.Add(this.changeFontSizeItem1);
            this.f.BarItems.Add(this.fontSizeIncreaseItem1);
            this.f.BarItems.Add(this.fontSizeDecreaseItem1);
            this.f.BarItems.Add(this.toggleFontBoldItem1);
            this.f.BarItems.Add(this.toggleFontItalicItem1);
            this.f.BarItems.Add(this.toggleFontUnderlineItem1);
            this.f.BarItems.Add(this.toggleFontDoubleUnderlineItem1);
            this.f.BarItems.Add(this.toggleFontStrikeoutItem1);
            this.f.BarItems.Add(this.toggleFontDoubleStrikeoutItem1);
            this.f.BarItems.Add(this.toggleFontSuperscriptItem1);
            this.f.BarItems.Add(this.toggleFontSubscriptItem1);
            this.f.BarItems.Add(this.changeFontColorItem1);
            this.f.BarItems.Add(this.changeFontBackColorItem1);
            this.f.BarItems.Add(this.changeTextCaseItem1);
            this.f.BarItems.Add(this.makeTextUpperCaseItem1);
            this.f.BarItems.Add(this.makeTextLowerCaseItem1);
            this.f.BarItems.Add(this.capitalizeEachWordCaseItem1);
            this.f.BarItems.Add(this.toggleTextCaseItem1);
            this.f.BarItems.Add(this.clearFormattingItem1);
            this.f.BarItems.Add(this.toggleBulletedListItem1);
            this.f.BarItems.Add(this.toggleNumberingListItem1);
            this.f.BarItems.Add(this.toggleMultiLevelListItem1);
            this.f.BarItems.Add(this.decreaseIndentItem1);
            this.f.BarItems.Add(this.ıncreaseIndentItem1);
            this.f.BarItems.Add(this.toggleParagraphAlignmentLeftItem1);
            this.f.BarItems.Add(this.toggleParagraphAlignmentCenterItem1);
            this.f.BarItems.Add(this.toggleParagraphAlignmentRightItem1);
            this.f.BarItems.Add(this.toggleParagraphAlignmentJustifyItem1);
            this.f.BarItems.Add(this.toggleShowWhitespaceItem1);
            this.f.BarItems.Add(this.changeParagraphLineSpacingItem1);
            this.f.BarItems.Add(this.setSingleParagraphSpacingItem1);
            this.f.BarItems.Add(this.setSesquialteralParagraphSpacingItem1);
            this.f.BarItems.Add(this.setDoubleParagraphSpacingItem1);
            this.f.BarItems.Add(this.showLineSpacingFormItem1);
            this.f.BarItems.Add(this.addSpacingBeforeParagraphItem1);
            this.f.BarItems.Add(this.removeSpacingBeforeParagraphItem1);
            this.f.BarItems.Add(this.addSpacingAfterParagraphItem1);
            this.f.BarItems.Add(this.removeSpacingAfterParagraphItem1);
            this.f.BarItems.Add(this.changeParagraphBackColorItem1);
            this.f.BarItems.Add(this.galleryChangeStyleItem1);
            this.f.BarItems.Add(this.findItem1);
            this.f.BarItems.Add(this.replaceItem1);
            this.f.BarItems.Add(this.ınsertPageBreakItem21);
            this.f.BarItems.Add(this.ınsertTableItem1);
            this.f.BarItems.Add(this.ınsertPictureItem1);
            this.f.BarItems.Add(this.ınsertFloatingPictureItem1);
            this.f.BarItems.Add(this.ınsertBookmarkItem1);
            this.f.BarItems.Add(this.ınsertHyperlinkItem1);
            this.f.BarItems.Add(this.editPageHeaderItem1);
            this.f.BarItems.Add(this.editPageFooterItem1);
            this.f.BarItems.Add(this.ınsertPageNumberItem1);
            this.f.BarItems.Add(this.ınsertPageCountItem1);
            this.f.BarItems.Add(this.ınsertTextBoxItem1);
            this.f.BarItems.Add(this.ınsertSymbolItem1);
            this.f.BarItems.Add(this.changeSectionPageMarginsItem1);
            this.f.BarItems.Add(this.setNormalSectionPageMarginsItem1);
            this.f.BarItems.Add(this.setNarrowSectionPageMarginsItem1);
            this.f.BarItems.Add(this.setModerateSectionPageMarginsItem1);
            this.f.BarItems.Add(this.setWideSectionPageMarginsItem1);
            this.f.BarItems.Add(this.showPageMarginsSetupFormItem1);
            this.f.BarItems.Add(this.changeSectionPageOrientationItem1);
            this.f.BarItems.Add(this.setPortraitPageOrientationItem1);
            this.f.BarItems.Add(this.setLandscapePageOrientationItem1);
            this.f.BarItems.Add(this.changeSectionPaperKindItem1);
            this.f.BarItems.Add(this.changeSectionColumnsItem1);
            this.f.BarItems.Add(this.setSectionOneColumnItem1);
            this.f.BarItems.Add(this.setSectionTwoColumnsItem1);
            this.f.BarItems.Add(this.setSectionThreeColumnsItem1);
            this.f.BarItems.Add(this.showColumnsSetupFormItem1);
            this.f.BarItems.Add(this.ınsertBreakItem1);
            this.f.BarItems.Add(this.ınsertPageBreakItem1);
            this.f.BarItems.Add(this.ınsertColumnBreakItem1);
            this.f.BarItems.Add(this.ınsertSectionBreakNextPageItem1);
            this.f.BarItems.Add(this.ınsertSectionBreakEvenPageItem1);
            this.f.BarItems.Add(this.ınsertSectionBreakOddPageItem1);
            this.f.BarItems.Add(this.changeSectionLineNumberingItem1);
            this.f.BarItems.Add(this.setSectionLineNumberingNoneItem1);
            this.f.BarItems.Add(this.setSectionLineNumberingContinuousItem1);
            this.f.BarItems.Add(this.setSectionLineNumberingRestartNewPageItem1);
            this.f.BarItems.Add(this.setSectionLineNumberingRestartNewSectionItem1);
            this.f.BarItems.Add(this.toggleParagraphSuppressLineNumbersItem1);
            this.f.BarItems.Add(this.showLineNumberingFormItem1);
            this.f.BarItems.Add(this.changePageColorItem1);
            this.f.BarItems.Add(this.ınsertTableOfContentsItem1);
            this.f.BarItems.Add(this.updateTableOfContentsItem1);
            this.f.BarItems.Add(this.addParagraphsToTableOfContentItem1);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem1);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem2);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem3);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem4);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem5);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem6);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem7);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem8);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem9);
            this.f.BarItems.Add(this.setParagraphHeadingLevelItem10);
            this.f.BarItems.Add(this.ınsertCaptionPlaceholderItem1);
            this.f.BarItems.Add(this.ınsertFiguresCaptionItems1);
            this.f.BarItems.Add(this.ınsertTablesCaptionItems1);
            this.f.BarItems.Add(this.ınsertEquationsCaptionItems1);
            this.f.BarItems.Add(this.ınsertTableOfFiguresPlaceholderItem1);
            this.f.BarItems.Add(this.ınsertTableOfFiguresItems1);
            this.f.BarItems.Add(this.ınsertTableOfTablesItems1);
            this.f.BarItems.Add(this.ınsertTableOfEquationsItems1);
            this.f.BarItems.Add(this.updateTableOfFiguresItem1);
            this.f.BarItems.Add(this.ınsertMergeFieldItem1);
            this.f.BarItems.Add(this.showAllFieldCodesItem1);
            this.f.BarItems.Add(this.showAllFieldResultsItem1);
            this.f.BarItems.Add(this.toggleViewMergedDataItem1);
            this.f.BarItems.Add(this.checkSpellingItem1);
            this.f.BarItems.Add(this.changeLanguageItem1);
            this.f.BarItems.Add(this.protectDocumentItem1);
            this.f.BarItems.Add(this.changeRangeEditingPermissionsItem1);
            this.f.BarItems.Add(this.unprotectDocumentItem1);
            this.f.BarItems.Add(this.switchToSimpleViewItem1);
            this.f.BarItems.Add(this.switchToDraftViewItem1);
            this.f.BarItems.Add(this.switchToPrintLayoutViewItem1);
            this.f.BarItems.Add(this.toggleShowHorizontalRulerItem1);
            this.f.BarItems.Add(this.toggleShowVerticalRulerItem1);
            this.f.BarItems.Add(this.zoomOutItem1);
            this.f.BarItems.Add(this.zoomInItem1);
            this.f.BarItems.Add(this.goToPageHeaderItem1);
            this.f.BarItems.Add(this.goToPageFooterItem1);
            this.f.BarItems.Add(this.goToNextHeaderFooterItem1);
            this.f.BarItems.Add(this.goToPreviousHeaderFooterItem1);
            this.f.BarItems.Add(this.toggleLinkToPreviousItem1);
            this.f.BarItems.Add(this.toggleDifferentFirstPageItem1);
            this.f.BarItems.Add(this.toggleDifferentOddAndEvenPagesItem1);
            this.f.BarItems.Add(this.closePageHeaderFooterItem1);
            this.f.BarItems.Add(this.toggleFirstRowItem1);
            this.f.BarItems.Add(this.toggleLastRowItem1);
            this.f.BarItems.Add(this.toggleBandedRowsItem1);
            this.f.BarItems.Add(this.toggleFirstColumnItem1);
            this.f.BarItems.Add(this.toggleLastColumnItem1);
            this.f.BarItems.Add(this.toggleBandedColumnItem1);
            this.f.BarItems.Add(this.galleryChangeTableStyleItem1);
            this.f.BarItems.Add(this.changeTableBorderLineStyleItem1);
            this.f.BarItems.Add(this.changeTableBorderLineWeightItem1);
            this.f.BarItems.Add(this.changeTableBorderColorItem1);
            this.f.BarItems.Add(this.changeTableBordersItem1);
            this.f.BarItems.Add(this.toggleTableCellsBottomBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsTopBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsLeftBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsRightBorderItem1);
            this.f.BarItems.Add(this.resetTableCellsAllBordersItem1);
            this.f.BarItems.Add(this.toggleTableCellsAllBordersItem1);
            this.f.BarItems.Add(this.toggleTableCellsOutsideBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsInsideBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsInsideHorizontalBorderItem1);
            this.f.BarItems.Add(this.toggleTableCellsInsideVerticalBorderItem1);
            this.f.BarItems.Add(this.toggleShowTableGridLinesItem1);
            this.f.BarItems.Add(this.changeTableCellsShadingItem1);
            this.f.BarItems.Add(this.selectTableElementsItem1);
            this.f.BarItems.Add(this.selectTableCellItem1);
            this.f.BarItems.Add(this.selectTableColumnItem1);
            this.f.BarItems.Add(this.selectTableRowItem1);
            this.f.BarItems.Add(this.selectTableItem1);
            this.f.BarItems.Add(this.showTablePropertiesFormItem1);
            this.f.BarItems.Add(this.deleteTableElementsItem1);
            this.f.BarItems.Add(this.showDeleteTableCellsFormItem1);
            this.f.BarItems.Add(this.deleteTableColumnsItem1);
            this.f.BarItems.Add(this.deleteTableRowsItem1);
            this.f.BarItems.Add(this.deleteTableItem1);
            this.f.BarItems.Add(this.ınsertTableRowAboveItem1);
            this.f.BarItems.Add(this.ınsertTableRowBelowItem1);
            this.f.BarItems.Add(this.ınsertTableColumnToLeftItem1);
            this.f.BarItems.Add(this.ınsertTableColumnToRightItem1);
            this.f.BarItems.Add(this.mergeTableCellsItem1);
            this.f.BarItems.Add(this.showSplitTableCellsForm1);
            this.f.BarItems.Add(this.splitTableItem1);
            this.f.BarItems.Add(this.toggleTableAutoFitItem1);
            this.f.BarItems.Add(this.toggleTableAutoFitContentsItem1);
            this.f.BarItems.Add(this.toggleTableAutoFitWindowItem1);
            this.f.BarItems.Add(this.toggleTableFixedColumnWidthItem1);
            this.f.BarItems.Add(this.toggleTableCellsTopLeftAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsMiddleLeftAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsBottomLeftAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsTopCenterAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsMiddleCenterAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsBottomCenterAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsTopRightAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsMiddleRightAlignmentItem1);
            this.f.BarItems.Add(this.toggleTableCellsBottomRightAlignmentItem1);
            this.f.BarItems.Add(this.showTableOptionsFormItem1);
            this.f.BarItems.Add(this.changeFloatingObjectFillColorItem1);
            this.f.BarItems.Add(this.changeFloatingObjectOutlineColorItem1);
            this.f.BarItems.Add(this.changeFloatingObjectOutlineWeightItem1);
            this.f.BarItems.Add(this.changeFloatingObjectTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectSquareTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectTightTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectThroughTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectTopAndBottomTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectBehindTextWrapTypeItem1);
            this.f.BarItems.Add(this.setFloatingObjectInFrontOfTextWrapTypeItem1);
            this.f.BarItems.Add(this.changeFloatingObjectAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectTopLeftAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectTopCenterAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectTopRightAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectMiddleLeftAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectMiddleCenterAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectMiddleRightAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectBottomLeftAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectBottomCenterAlignmentItem1);
            this.f.BarItems.Add(this.setFloatingObjectBottomRightAlignmentItem1);
            this.f.BarItems.Add(this.floatingObjectBringForwardSubItem1);
            this.f.BarItems.Add(this.floatingObjectBringForwardItem1);
            this.f.BarItems.Add(this.floatingObjectBringToFrontItem1);
            this.f.BarItems.Add(this.floatingObjectBringInFrontOfTextItem1);
            this.f.BarItems.Add(this.floatingObjectSendBackwardSubItem1);
            this.f.BarItems.Add(this.floatingObjectSendBackwardItem1);
            this.f.BarItems.Add(this.floatingObjectSendToBackItem1);
            this.f.BarItems.Add(this.floatingObjectSendBehindTextItem1);
            this.f.Control = this.richEditControl1;
            // 
            // opsDataSet
            // 
            ...
            this.Name = "ProjeSablonEditXF";
            this.Text = "ProjeSablonEditXF";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ProjeSablonEditXF_FormClosing);
            this.Load += new System.EventHandler(this.ProjeSablonEditXF_Load);
        ...
        private DevExpress.XtraRichEdit.UI.RichEditBarController f;
